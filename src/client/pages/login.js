...
class Login extends Component {
  ...
  generateOTP() {
    ...
    request.open(
      'GET',
      'http://localhost:9080/mfp/api/adapters/javaAdapter/resource/generateOTP'
    );
  ...
  handleClick = event => {
    ...
    if (event.target.id == 'loginForm') {
      var url =
        'http://localhost:9080/mfp/api/adapters/javaAdapter/resource/loginPost';
      var mythis = this;
      var request = new XMLHttpRequest();
      ...
      var url =
        'http://localhost:9080/mfp/api/adapters/javaAdapter/resource/pinAuth';
      var mythis = this;
      var request = new XMLHttpRequest();
      request.open('POST', url);
      request.onreadystatechange = function() {
      ...
      var url =
        'http://localhost:9080/mfp/api/adapters/javaAdapter/resource/otpAuth';
      ...
      var url =
        'http://localhost:9080/mfp/api/adapters/javaAdapter/resource/twoFactorAuth';
      var mythis = this;
      var request = new XMLHttpRequest();
      request.open('POST', url);
      request.onreadystatechange = function() {
